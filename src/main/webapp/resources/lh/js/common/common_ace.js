/** ace inline scripts related to this page */
jQuery(function($) {
	...
	// flot chart resize plugin, somehow manipulates default browser resize
	// event to optimize it!
	...
	var $tooltip = $("<div class='tooltip top in'><div class='tooltip-inner'></div></div>")
			.hide().appendTo('body');
	...
	$('#tasks').sortable({
				...
				stop : function(event, ui) {
					// just for Chrome!!!! so that dropdowns on items don't
					// appear below other items after being moved
