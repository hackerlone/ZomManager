	...
	<div class="main-content-inner">
		...
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li class="active">修改用户-->${user.displayName}</li>
			</ul><!-- /.breadcrumb -->			
		</div>
					...
					<div class="form-group">
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<button class="btn btn-info" type="button" onclick="updatePassword(${user.id});">
...
<script src="<%=request.getContextPath()%>/resources/lh/js/user/pwdUpdate.js" title="v"></script>
