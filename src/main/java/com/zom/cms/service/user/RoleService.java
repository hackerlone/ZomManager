...
public class RoleService implements IRoleService {
	...
	public List<Role> selectListByCondition(Map<String, Object> map) {
		return roleDao.selectListByCondition(map);
	}
	public Role selectByCondition(Map<String, Object> map) {
		return roleDao.selectByCondition(map);
	}
	public int selectCountByCondition(Map<String, Object> map) {
		return roleDao.selectCountByCondition(map);
	}
