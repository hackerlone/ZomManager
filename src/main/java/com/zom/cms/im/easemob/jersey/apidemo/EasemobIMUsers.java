package com.zom.cms.im.easemob.jersey.apidemo;

import java.util.ArrayList;
import java.util.List;

import com.zom.cms.im.easemob.jersey.vo.ClientSecretCredential;
...
import com.zom.cms.im.easemob.comm.HTTPMethod;
import com.zom.cms.im.easemob.comm.Roles;
import com.zom.cms.im.easemob.jersey.utils.JerseyUtils;
import com.zom.cms.im.easemob.jersey.vo.Credential;
import com.zom.cms.im.easemob.jersey.vo.EndPoints;
...
public class EasemobIMUsers {
	...
	public static ObjectNode createNewIMUserSingle(ObjectNode dataNode) {
		...
		try {
			...
			webTarget = EndPoints.USERS_TARGET.resolveTemplate("org_name",APPKEY.split("#")[0]).resolveTemplate("app_name",
					APPKEY.split("#")[1]);
			...
			LOGGER.error("Exception caught. createNewIMUserSingle() failed ");
		}
	...
	public static ObjectNode createNewIMUserBatch(ArrayNode dataArrayNode) {
		...
		try {
			...
			LOGGER.error("Exception caught. createNewIMUserBatch() failed ");
		}
	...
	public static ObjectNode getIMUsersByPrimaryKey(String userPrimaryKey) {
		...
		try {
			...
			LOGGER.error("Exception caught. getIMUsersByPrimaryKey() failed ");
		}
	...
	public static ObjectNode deleteIMUserByUserPrimaryKey(String userPrimaryKey) {
		...
		try {
			...
			LOGGER.error("Exception caught. deleteIMUserByUserPrimaryKey() failed ");
		}
	...
	public static ObjectNode deleteIMUserByUsernameBatch(Long limit,
		...
		try {
			...
			LOGGER.error("Exception caught. deleteIMUserByUsernameBatch() failed ");
		}
	...
	public static ObjectNode modifyIMUserPasswordWithAdminToken(
		...
		try {
			...
			LOGGER.error("Exception caught. modifyIMUserPasswordWithAdminToken() failed ");
		}
	...
	public static ObjectNode addFriendSingle(String ownerUserPrimaryKey,
		...
		try {
			...
			LOGGER.error("Exception caught. addFriendSingle() failed ");
		}
	...
	public static ObjectNode deleteFriendSingle(String ownerUserPrimaryKey,
		...
		try {
			...
			LOGGER.error("Exception caught. deleteFriendSingle() failed ");
		}
	...
	public static ObjectNode getFriends(String ownerUserPrimaryKey) {
		...
		try {
			...
			LOGGER.error("Exception caught. getFriends() failed ");
		}
