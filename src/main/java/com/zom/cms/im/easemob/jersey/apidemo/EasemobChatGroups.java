...
//import com.zeroonemore.rtv.server.im.easemob.jersey.vo.UsernamePasswordCredentail;
...
public class EasemobChatGroups {
	...
	public static ObjectNode getAllChatgroupids() {
		...
		try {
			...
			LOGGER.error("Exception caught. getAllChatgroupids() failed ");
		}
	...
	public static ObjectNode getGroupDetailsByChatgroupid(String[] chatgroupIDs) {
		...
		try {
			...
			LOGGER.error("Exception caught. UsernamePasswordCredentail() failed ");
		}
	...
	public static ObjectNode creatChatGroups(ObjectNode dataObjectNode) {
		...
		if (dataObjectNode.has("members") && !dataObjectNode.path("members").isArray()) {
			...
			objectNode.put("message", "Property that named members shall have at least 1 node .");
		...
		try {
			...
			objectNode=null;
			LOGGER.error("Exception caught. creatChatGroups() failed ");
		}
	...
	public static ObjectNode deleteChatGroups(String chatgroupid) {
		...
		try {
			...
			LOGGER.error("Exception caught. deleteChatGroups() failed ");
		}
	...
	public static ObjectNode getAllMemberssByGroupId(String chatgroupid) {
		...
		try {
			...
			LOGGER.error("Exception caught. getAllMemberssByGroupId() failed ");
		}
	...
	public static ObjectNode addUserToGroup(String chatgroupid, String userprimarykey) {
		...
		try {
			...
			LOGGER.error("Exception caught. addUserToGroup() failed ");
		}
	...
	public static ObjectNode deleteUserFromGroup(String chatgroupid, String userprimarykey) {
		...
		try {
			...
			LOGGER.error("Exception caught. deleteUserFromGroup() failed ");
		}
